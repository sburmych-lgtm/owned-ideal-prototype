...
Локальні заміри (реальні байти на дроті, brotli): перший екран — 380 КБ на
мобільному (0 КБ відео), 616 КБ без відео на десктопі; JS 4 КБ на дроті;
0 порушень axe-core на 1440 та 390 px.
